...
const Dashboard = () => {
  ...
  const [allResume, setAllResume] = useState([])
   const [showCreateResume, setShowCreateResume] = useState(false)
    const [showUploadResume, seShowUploadResume] = useState(false)
    ...
    <div className='max-w-7xl mx-auto px-4 py-8'>
      ...
      <div className='grid grid-cols-2 sm:flex flex-wrap gap-4'>
        {allResume.map((resume,index)=>{
          ...
          return(
            <button key={index} className='relative w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer' style={{background: `liner-gradient(135deg, ${baseColor}10, ${baseColor}40`, borderColor: baseColor + '40'}}>
